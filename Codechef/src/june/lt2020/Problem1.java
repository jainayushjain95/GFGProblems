...
public class Problem1 {
	 ...
	 * Reader(); int t = sc.nextInt(); while(t != 0) { t--; solve(sc.nextInt(),
	 * sc.nextInt()); } }
	 * 
	 * public static void solve(int S, int N) { int coinsCount = 0; if(S % 2 != 0) {
	 * coinsCount++; S--; } while(S != 0) { int curr = S / N; coinsCount += curr; S
	 * = S - (curr * N); N = Math.min(N - 2, S); } System.out.println(coinsCount); }
	 * 
	 * 
	 * static class Reader { final private int BUFFER_SIZE = 1 << 16; private
