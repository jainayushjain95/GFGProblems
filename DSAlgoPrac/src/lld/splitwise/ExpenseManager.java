...
public class ExpenseManager {
    ...
    public void addExpense(ExpenseType expenseType, double amount, String paidByVar, List<Split> splits) {
    	User paidBy = userMap.get(paidByVar);
        Expense expense = ExpenseService.createExpense(expenseType, splits, paidBy, amount);
        expenses.add(expense);
        for (Split split : expense.getSplits()) {
            String paidTo = split.getUser().getId();
            if(paidTo.equals(paidByVar)) {
            	continue;
            }
